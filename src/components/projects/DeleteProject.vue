<template>
  <div v-if="isAuth">
    ...
    <v-dialog class="projectModal" v-model="showModal" width="300px"
      ...
      <v-card>
        <v-form :disabled="load.project" @submit.prevent="deleteReq" v-model="valid" ref="form">
  ...
  data(){
    return{
      ...
      texts: {
        ...
        message: new Text('Введите stringId, чтобы удалить проект.', 'Input stringId to delete project.')
      },
      input: '',
      valid: false,
      rules: [
