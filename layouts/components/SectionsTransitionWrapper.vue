...
<template>
  <div class="sections-transition-wrapper">
    <div class="sections-transition-wrapper__bar" :class="currentBarVariation" />
  </div>
</template>
...
#default-layout:has(.section-enter-active, .section-leave-active) .sections-transition-wrapper {
  display: block;
}

/* bar */
#default-layout:has(.section-enter-active, .section-leave-active) .sections-transition-wrapper__bar{
...
#default-layout:has(.section-leave-to, .section-enter-from) .sections-transition-wrapper__bar{
