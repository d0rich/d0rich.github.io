<template>
  <div id="big-bang-button-animation">
    <TransitionGroup tag="div" class="bbb__text-container" @enter="onEnter" @leave="onLeave" >
      <span v-for="symbol, index in symbols" :i="index" :key="index" v-text="symbol" />
    </TransitionGroup>
  </div>
</template>
...
export default defineComponent({
  ...
  setup(){
    ...
    function pathFromIndex(i: number){
      ...
      return paths.intermediate[Math.floor(Math.random() * paths.intermediate.length)]
